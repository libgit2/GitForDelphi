...
//   } git_strarray;
   ...
   git_config_file_foreach_callback = function (const key: PAnsiChar; data: PByte): Integer; stdcall;
...
//   };
   ...
   git_config_foreach_callback = function (const key: PAnsiChar; data: PByte): Integer; stdcall;
...
var
   ...
   git_blob_rawsize:                   function (blob: Pgit_blob): Integer; stdcall;
   ...
   git_commit_message_short:           function (commit: Pgit_commit): PAnsiChar; stdcall;
   ...
   git_commit_create:                  function (oid: Pgit_oid; repo: Pgit_repository; const update_ref: PAnsiChar; const author, committer: Pgit_signature; const message_: PAnsiChar; const tree_oid: Pgit_oid; parent_count: Integer; const parent_oids: PPgit_oid): Integer; stdcall;
   ...
   git_commit_create_o:                function (oid: Pgit_oid; repo: Pgit_repository; const update_ref: PAnsiChar; const author, committer: Pgit_signature; const message_: PAnsiChar; const tree: Pgit_tree; parent_count: Integer; const parents: PPgit_commit): Integer; stdcall;
   ...
   git_config_get_int:                 function (cfg: Pgit_config; const name: PAnsiChar; var out_: Integer): Integer; stdcall;
   // GIT_EXTERN(int) git_config_get_long(git_config *cfg, const char *name, long int *out);
   git_config_get_long:                function (cfg: Pgit_config; const name: PAnsiChar; var out_: LongInt): Integer; stdcall;
   ...
   git_config_set_int:                 function (cfg: Pgit_config; const name: PAnsiChar; value: Integer): Integer; stdcall;
   // GIT_EXTERN(int) git_config_set_long(git_config *cfg, const char *name, long int value);
   git_config_set_long:                function (cfg: Pgit_config; const name: PAnsiChar; value: LongInt): Integer; stdcall;
   ...
   git_config_foreach:                 function (cfg: Pgit_config; callback: Pgit_config_foreach_callback; data: PByte): Integer; stdcall;
   ...
   git_object_close:                   procedure (object_: Pgit_object); stdcall;
   ...
   git_odb_close:                      procedure (db: Pgit_odb); stdcall;
   ...
   git_odb_backend_loose:              function (var backend_out: Pgit_odb_backend; const objects_dir: PAnsiChar): Integer; stdcall;

   // GIT_EXTERN(void) git_odb_object_close(git_odb_object *object);
   git_odb_object_close:               procedure (object_: Pgit_odb_object); stdcall;
   ...
   git_repository_open2:               function (var repository: Pgit_repository; const git_dir, git_object_directory, git_index_file, git_work_tree: PAnsiChar): Integer; stdcall;
   ...
   git_repository_open3:               function (var repository: Pgit_repository; const git_dir: PAnsiChar; object_database: Pgit_odb; const git_index_file, git_work_tree: PAnsiChar): Integer; stdcall;
   ...
   git_repository_path:                function (repo: Pgit_repository; id: git_repository_pathid): PAnsiChar; stdcall;
   ...
   git_repository_config:              function (var out_: Pgit_config; repo: Pgit_repository; const user_config_path, system_config_path: PAnsiChar): Integer; stdcall;

   // GIT_EXTERN(git_odb *) git_repository_database(git_repository *repo);
   git_repository_database:            function (repo: Pgit_repository): Pgit_odb; stdcall;
   ...
   git_signature_new:                  function (const name, email: PAnsiChar; time: git_time_t; offset: Integer): Pgit_signature; stdcall;
   // GIT_EXTERN(git_signature *) git_signature_now(const char *name, const char *email);
   git_signature_now:                  function (const name, email: PAnsiChar): Pgit_signature; stdcall;
   ...
   git_tag_create:                     function (oid: Pgit_oid; repo: Pgit_repository; const tag_name: PAnsiChar; const target: Pgit_oid; target_type: git_otype; const tagger: Pgit_signature; const message_: PAnsiChar): Integer; stdcall;
   ...
   git_tag_create_o:                   function (oid: Pgit_oid; repo: Pgit_repository; const tag_name: PAnsiChar; const target: Pgit_object; const tagger: Pgit_signature; const message_: PAnsiChar): Integer; stdcall;
   ...
   git_tag_create_f:                   function (oid: Pgit_oid; repo: Pgit_repository; const tag_name: PAnsiChar; const target: Pgit_oid; target_type: git_otype; const tagger: Pgit_signature; const message_: PAnsiChar): Integer; stdcall;
   ...
   git_tag_create_fo:                  function (oid: Pgit_oid; repo: Pgit_repository; const tag_name: PAnsiChar; const target: Pgit_object; const tagger: Pgit_signature; const message_: PAnsiChar): Integer; stdcall;
   // GIT_EXTERN(int) git_tag_create_frombuffer(git_oid *oid, git_repository *repo, const char *buffer);
   git_tag_create_frombuffer:          function (oid: Pgit_oid; repo: Pgit_repository; const buffer: PAnsiChar): Integer; stdcall;
   ...
   git_reference_create_oid:           function (var ref_out: Pgit_reference; repo: Pgit_repository; const name: PAnsiChar; const id: Pgit_oid): Integer; stdcall;
   // GIT_EXTERN(int) git_reference_create_oid_f(git_reference **ref_out, git_repository *repo, const char *name, const git_oid *id);
   git_reference_create_oid_f:         function (var ref_out: Pgit_reference; repo: Pgit_repository; const name: PAnsiChar; const id: Pgit_oid): Integer; stdcall;
   ...
   git_reference_rename:               function (ref: Pgit_reference; const new_name: PAnsiChar): Integer; stdcall;
   // GIT_EXTERN(int) git_reference_rename_f(git_reference *ref, const char *new_name);
   git_reference_rename_f:             function (ref: Pgit_reference; const new_name: PAnsiChar): Integer; stdcall;
   ...
   git_reference_create_symbolic:      function (var ref_out: Pgit_reference; repo: Pgit_repository; const name: PAnsiChar; const target: PAnsiChar): Integer; stdcall;
   ...
   git_reference_create_symbolic_f:    function (var ref_out: Pgit_reference; repo: Pgit_repository; const name, target: PAnsiChar): Integer; stdcall;
